...
- `01_lcd_button_menu_test/`: 16x2 I2C LCD and 3-Button dedicated interface test (Green 1.5L/1.75L, Blue 290 ML / Mismo, Red Reset).
...
- `06_coin_hopper_relay_test/`: 12V Coin hopper motor, 5V relay switch, and D7 pulse interrupt payout test (₱20 and ₱3 targets).
