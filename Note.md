...
A Plastic bottle coin exchanger system, where the people put 1.5 liter bottle or a Mismo bottle search here on the PH ok
1.5 5 bottles is equal to 3 pesos coins
Mismo 10 Bottles is equal to 3 pesos coins

The user pick on the LCD what bottle he will insert if its 1.5 or mismo and if he pick the 1.5 it will show on the LCD needs to input 5 pueces of 1.5 0/5 1.5 Bottle
until it reachs the user put 1 bottle it will verify if its rejected it iwll prompt on the LCD Pls try again i have a speaker also just make a buzzer for invalid input and if its correct it will accept the bottle and proceed to insert again a bottle until it reaches 5 pices if all is good it will dispense a 3 pesos on the dispenser and back to the start again
